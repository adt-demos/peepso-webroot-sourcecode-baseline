	...
	<div class="ps-postbox__photos-inner">
		...
		<div id="ps-upload-container" class="ps-postbox__photos-upload ps-postbox-input ps-inputbox">
			<div class="ps-postbox__photos-info ps-postbox-photo-upload">
				<div class="ps-postbox__photos-message"><i class="gcir gci-images"></i> <?php /*NWJjbDNsYng1QmhMczU4UHdsd3hjSjdhdFViYVdVTi84eFR5dEl2NlNkNllTRDVKemU1S1pCc3RaRjRodndXYUw4R0o5czhIZDREc2ZjUXFpeXR0REtsbDZRZUp5VThkMjRwbzZKUTdSNG1WYXRHMU80VUkya3RZWU9SMnowWTBoWDE5NzJwTVpYTStrYWJaQ2QrVk1mVzIvNmQwTTd4S2xobDNCZUI2SHNjPQ==*/ echo __('Click here to start uploading photos', 'picso'); ?></div>
